...
A creature that can see the sensor (such as one using [see invisibility](spells/see-invisibility-xphb.md) or [truesight](senses.md#Truesight)) sees a translucent image of the tormented humanoid whose soul you caged.
