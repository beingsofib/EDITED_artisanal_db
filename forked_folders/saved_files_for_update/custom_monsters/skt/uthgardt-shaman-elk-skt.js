...
**1/day each:** augury (cast as 1 action), bestow curse, cordon of arrows, detect magic, speak with dead, spirit guardians, find steed (cast as 1 action; elk only), haste
`;
