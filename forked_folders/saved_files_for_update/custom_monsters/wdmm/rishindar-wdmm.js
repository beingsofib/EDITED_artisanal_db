...
***Innate Spellcasting (Psionics).*** Rishindar's innate spellcasting ability is Wisdom. It can innately cast the following spells, requiring no components:
...
***Psychic Defense.*** While Rishindar is wearing no armor and wielding no shield, its AC includes its Wisdom modifier.

## Actions

***Multiattack.*** Rishindar makes two unarmed strikes.
