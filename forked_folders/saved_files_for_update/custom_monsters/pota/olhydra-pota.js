...
***Innate Spellcasting.*** Olhydras innate spellcasting ability is Charisma (spell save DC 20, +12 to hit with spell attacks). She can innately cast the following spells, requiring no material components:
...
***Summon Elementals (1/Day).*** Olhydra summons up to three [water elementals](/3-Mechanics/CLI/bestiary/elemental/water-elemental.md) and loses 30 hit points for each elemental she summons. Summoned elementals have maximum hit points, appear within 100 feet of Olhydra, and disappear if Olhydra is reduced to 0 hit points.
...
- Water within 120 feet of Olhydra becomes murky and opaque until initiative count 20 of the next round. A creature with darkvision cant see through the water, and light can't illuminate it.
...
Olhydras presence in an elemental node creates a number of widespread effects—bad weather, strong tides, and increasing aggression from dangerous sea life.
