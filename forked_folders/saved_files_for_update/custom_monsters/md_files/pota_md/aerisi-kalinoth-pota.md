...
![](bestiary/PotA/Aerisi Kalinoth.webp#right)
...
![](bestiary/tokens/PotA/Aerisi Kalinoth.webp#token)
...
***Windvane.*** *Melee  or Ranged Weapon Attack:* +9 to hit, reach 5 ft. or range 20/60 ft., one target. *Hit:* 9 (1d6 + 6) piercing damage, or 10 (1d8 + 6) piercing damage if used with two hands to make a melee attack, plus 3 (d6) lightning damage.
