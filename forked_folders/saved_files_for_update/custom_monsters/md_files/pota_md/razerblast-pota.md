...
![](bestiary/PotA/Razerblast.webp#right)
...
title: Razerblast
![](bestiary/tokens/PotA/Razerblast.webp#token)
...
***Searing Armor.*** The razerblast's armor is hot. Any creature grappling the razerblast or grappled by it takes 5 (d10) fire damage at the end of that creature's turn.
...
***Spear.*** *Melee  or Ranged Weapon Attack:* +6 to hit, reach 5 ft. or range 20/60 ft., one target. *Hit:* 6 (1d6 + 3) piercing damage, or 7 (1d8 + 3) piercing damage if used with two hands to make a melee attack, plus 3 (d6) fire damage.
