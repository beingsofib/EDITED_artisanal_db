...
# Dao (Disguises)
*Source: Monster Manual p. 143, Princes of the Apocalypse*  
...
**At will:** detect evil and good, detect magic, stone shape, disguise self (often with a longer duration than is normal for that spell; see Disguises)

**3/day each:** passwall, move earth, tongues, true polymorph (mightier genies only; see Disguises)

**1/day each:** conjure elemental ([earth elemental](/3-Mechanics/CLI/bestiary/elemental/earth-elemental.md) only), gaseous form, invisibility, phantasmal killer, plane shift, wall of stone
