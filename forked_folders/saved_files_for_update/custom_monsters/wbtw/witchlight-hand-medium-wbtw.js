...
***Secret Expertise.*** The hand has one of these additional skills: Acrobatics Acrobatics (+6), Animal Handling Animal Handling (+5), Arcana Arcana (+5), Athletics Athletics (+4), Medicine Medicine (+5), or Performance Performance (+5).
