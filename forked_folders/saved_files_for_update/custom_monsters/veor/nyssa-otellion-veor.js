...
***Devil's Sight.*** Magical darkness doesn't impede Nyssa's darkvision.

***Magic Resistance.*** Nyssa has advantage on saving throws against spells and other magical effects.

## Actions

***Multiattack.*** Nyssa makes three Bite or Lightning Strike attacks.
...
***Spellcasting.*** Nyssa casts one of the following spells, using Intelligence as the spellcasting ability (spell save DC 20):
...
***Teleport.*** Nyssa teleports, along with any equipment it is wearing or carrying, up to 30 feet to an unoccupied space that it can see.
`;
