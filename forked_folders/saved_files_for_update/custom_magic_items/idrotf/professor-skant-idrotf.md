...
- The [tarrasque](/3-Mechanics.CLI/bestiary/monstrosity/tarrasque-xmm.md) (see the Monster Manual)  
...
In addition to the knowledge it possesses, Professor Skant can cast the [mage hand](/3-Mechanics.CLI/spells/mage-hand-xphb.md) cantrip at will. It uses the spell only to transport itself. Its spellcasting ability is Intelligence.
