...
![A Docent](file://C:\Users\cgray\Desktop\clihome\5etools-img/adventure/VEoR/070-04-004.docent.webp#right)
...
Whenever you end your turn with 0 hit points, the docent can make a Wisdom ([Medicine](/3-Mechanics/CLI/skills.md#Medicine)) check with a +6 bonus. If this check succeeds, the docent stabilizes you.
...
**Skills**. The docent has a +7 bonus to one of the following skills (roll a `d4`): (1) [Arcana](/3-Mechanics/CLI/skills.md#Arcana), (2) [History](/3-Mechanics/CLI/skills.md#History), (3) [Investigation](/3-Mechanics/CLI/skills.md#Investigation), or (4) [Nature](/3-Mechanics/CLI/skills.md#Nature).

**Spells**. The docent knows one of the following spells and can cast it at will, requiring no components (roll a `d6`): (1–2) [detect evil and good](/3-Mechanics.CLI/spells/detect-evil-and-good-xphb.md) or (3–6) [detect magic](/3-Mechanics.CLI/spells/detect-magic-xphb.md). The docent decides when to cast the spell.
