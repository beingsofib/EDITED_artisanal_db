...
![](file://C:\Users\cgray\Desktop\clihome\5etools-img/items/MOT/Akmon, Hammer of Purphoros.webp#right)
...
While holding the hammer, you have resistance to fire damage and are immune to [exhaustion](/3-Mechanics/CLI/conditions.md#Exhaustion). Additionally, you have proficiency with [smith's tools](/3-Mechanics.CLI/items/smiths-tools-xphb.md) and have advantage on all ability checks made using them.
