...
![](file://C:\Users\cgray\Desktop\clihome\5etools-img/items/XDMG/Blackrazor.webp#right)
...
You gain a +3 bonus to attack rolls and damage rolls made with this magic weapon. If you hit an Undead with this weapon, you take `1d10` Necrotic damage, and the target regains `1d10` [Hit Points](/3-Mechanics/CLI/variant-rules/hit-points-xphb.md). If this Necrotic damage reduces you to 0 [Hit Points](/3-Mechanics/CLI/variant-rules/hit-points-xphb.md), Blackrazor devours your soul (see "Devour Soul" below).
