...
| 4 | The egg contains a [potion of giant strength (hill giant)](/3-Mechanics.CLI/items/potion-of-hill-giant-strength-xdmg.md) with no container. |
| 5 | The egg holds a [pearl of power](/3-Mechanics.CLI/items/pearl-of-power-xdmg.md). |
| 6 | The egg contains a [brooch of shielding](/3-Mechanics.CLI/items/brooch-of-shielding-xdmg.md). |
| 7 | The egg contains a [figurine of wondrous power (silver raven)](/3-Mechanics.CLI/items/figurine-of-wondrous-power-silver-raven-xdmg.md) that activates automatically as the egg is opened, releasing what appears to be a living bird. |
