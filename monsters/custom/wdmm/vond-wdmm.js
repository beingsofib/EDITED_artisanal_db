...
***Innate Spellcasting (Psionics).*** Vond's innate spellcasting ability is Wisdom. It can innately cast the following spells, requiring no components:
...
***Psychic Defense.*** While Vond is wearing no armor and wielding no shield, its AC includes its Wisdom modifier.

## Actions

***Multiattack.*** Vond makes two unarmed strikes.
