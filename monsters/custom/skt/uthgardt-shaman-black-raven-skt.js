...
**1/day each:** augury (cast as 1 action), bestow curse, cordon of arrows, detect magic, speak with dead, spirit guardians, animal messenger (raven only), polymorph (self only; into a raven only)
`;
