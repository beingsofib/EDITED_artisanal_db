...
***Innate Spellcasting.*** The empyreans innate spellcasting ability is Charisma (spell save DC 23, +15 to hit with spell attacks). It can innately cast the following spells, requiring no material components:
...
***Magic Weapons.*** The empyreans weapon attacks are magical.

## Actions

***Maul.*** *Melee Weapon Attack:* +17 to hit, reach 10 ft., one target. *Hit:* 31 (6d6 + 10) bludgeoning damage. If the target is a creature, it must succeed on a DC 15 Constitution saving throw or be stunned until the end of the empyreans next turn.

***Bolt.*** *Ranged Spell Attack:* +15 to hit, range 600 ft., one target. *Hit:* 24 (7d6) damage of one of the following types (empyreans choice): acid, cold, fire, force, lightning, radiant, or thunder.

## Legendary Actions

***Attack.*** The empyrean makes one attack.

***Bolster.*** The empyrean bolsters all nonhostile creatures within 120 feet of it until the end of its next turn. Bolstered creatures cant be charmed or frightened, and they gain advantage on ability checks and saving throws until the end of the empyreans next turn.
