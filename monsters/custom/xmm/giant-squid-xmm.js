...
***Ink Cloud (1/Day).*** Trigger: The squid takes damage while underwater. _Response:_ The squid releases ink that fills a 15-foot Cube centered on itself, and the squid moves up to its Swim Speed. The Cube is Heavily Obscured for 1 minute or until a strong current or similar effect disperses the ink.
`;
