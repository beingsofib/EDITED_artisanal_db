...
At the end of each of your turns, one creature of your choice that is on the ground in the cube must succeed on a Strength saving throw or become [restrained](conditions.md#Restrained) until the spell ends. A [restrained](conditions.md#Restrained) creature can use an action to make a Strength ([Athletics](skills.md#Athletics)) check against your spell save DC, ending the effect on itself on a success.
