...
![Frost Brand (Scimitar)](file://C:\Users\cgray\Desktop\clihome\5etools-img/items/XDMG/Frost Brand.webp#right)


When you hit with an attack roll using this magic weapon, the target takes an extra `1d6` Cold damage. In addition, while you hold the weapon, you have [Resistance](/3-Mechanics/CLI/variant-rules/resistance-xphb.md) to Fire damage.
