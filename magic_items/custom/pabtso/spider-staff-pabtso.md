...
The staff has 10 charges. While holding it, you can expend the requisite number of charges to cast one of the following spells from the staff: [spider climb](/3-Mechanics.CLI/spells/spider-climb-xphb.md) (1 charge) or [web](/3-Mechanics.CLI/spells/web-xphb.md) (2 charges; spell save DC 15).
