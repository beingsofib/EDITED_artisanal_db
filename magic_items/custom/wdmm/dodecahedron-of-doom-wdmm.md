...
| 3–4 | The dodecahedron casts [light](/3-Mechanics.CLI/spells/light-xphb.md) on itself. The effect lasts until a creature touches the die. |
| 5–6 | The dodecahedron casts [ray of frost](/3-Mechanics.CLI/spells/ray-of-frost-xphb.md) (+5 to hit), targeting a random creature within 60 feet of it that doesn't have total cover against the attack. |
| 7–8 | The dodecahedron casts [shocking grasp](/3-Mechanics.CLI/spells/shocking-grasp-xphb.md) (+5 to hit) on the next creature that touches it. |
| 9–10 | The dodecahedron casts [darkness](/3-Mechanics.CLI/spells/darkness-xphb.md) on itself. The effect has a duration of 10 minutes. |
