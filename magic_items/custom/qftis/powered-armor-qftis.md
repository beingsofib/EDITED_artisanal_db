...
This suit of technologically advanced plate armor includes an under-suit that can fully seal, a helmet with a full face mask and crystal lenses in the eyeholes, and a set of gauntlets. The armor is powered by an [energy cell](/3-Mechanics.CLI/items/energy-cell-xdmg.md) stored in a compartment on the thigh plate.

Placing a full [energy cell](/3-Mechanics.CLI/items/energy-cell-xdmg.md) in the armor gives the armor 24 charges. A suit of powered armor functions as a suit of normal plate armor, even when it has 0 charges remaining.
...
While the armor has charges remaining, its [energy cell](/3-Mechanics.CLI/items/energy-cell-xdmg.md) can't be removed. Once the armor has 0 charges, you can replace the [energy cell](/3-Mechanics.CLI/items/energy-cell-xdmg.md) with a new cell by using an action or a bonus action.
