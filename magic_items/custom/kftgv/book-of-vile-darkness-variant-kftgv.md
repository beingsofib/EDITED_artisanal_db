...
![](file://C:\Users\cgray\Desktop\clihome\5etools-img/items/DMG/Book of Vile Darkness.webp#right)
...
- **Circle of Death.** While attuned to the book, you can cast [circle of death](/3-Mechanics.CLI/spells/circle-of-death-xphb.md) (save DC 20) from it as an action. After you cast the spell, roll a `d6`. On a roll of 1-5, you can't use this property again until the next dawn.  
- **Condition Immunities.** While attuned to the book, you can't be [charmed](/3-Mechanics/CLI/conditions.md#Charmed) or [frightened](/3-Mechanics/CLI/conditions.md#Frightened).  
- **Evil Presence.** The book houses an evil spirit that is hostile toward you. When you become attuned to the book, the spirit tries to leave the book and enter your body. If you fail a DC 20 Charisma saving throw, it succeeds, and you become an NPC under the DM's control until the intruding spirit is banished using magic such as the [dispel evil and good](/3-Mechanics.CLI/spells/dispel-evil-and-good-xphb.md) spell. The banished spirit returns to the book.  
...
While you are attuned to the book and holding it, you can use an action to cast the [dominate monster](/3-Mechanics.CLI/spells/dominate-monster-xphb.md) spell on an evil target (save DC 18). You can't use this property again until the next dawn.
...
If a [solar](/3-Mechanics.CLI/bestiary/celestial/solar-xmm.md) tears the book in two, the book is destroyed for `1d100` years, after which it reforms in some dark corner of the multiverse.
